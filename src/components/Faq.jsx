...
export default function Faq() {
  ...
  return (
    <div id="faq" className=" grid sm:px-5 md:px-28 sm:grid-cols-1 lg:grid-cols-2 py-28 gap-10">
    ...
    <div data-aos="fade-left"
     className="flex flex-col  space-y-10 px-10 ">
      ...
      <Accordion  open={open === 1} icon={<Icon id={1} open={open} />}>
        <AccordionHeader className=" font-medium" onClick={() => handleOpen(1)}>How much time does it take to find a Property?</AccordionHeader>
      ...
      <Accordion  open={open === 2} icon={<Icon id={2} open={open} />}>
        <AccordionHeader className=" font-medium" onClick={() => handleOpen(2)}>
      ...
      <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
        <AccordionHeader className=" font-medium" onClick={() => handleOpen(3)}>
      ...
      <Accordion  open={open === 4} icon={<Icon id={4} open={open} />}>
        <AccordionHeader className=" font-medium" onClick={() => handleOpen(4)}>
      ...
      <Accordion open={open === 5} icon={<Icon id={5} open={open} />}>
        <AccordionHeader className=" font-medium" onClick={() => handleOpen(5)}>
