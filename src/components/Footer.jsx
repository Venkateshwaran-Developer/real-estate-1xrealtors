    ...
    <span className="relative text-black group-hover:text-white">Button Text</span>
                ...
                <div className="footer-links flex justify-center  items-center w-full h-full text-2xl font-bold">
                    <ul className='space-y-4'>
                        <li className='flex gap-2 justify-start items-center'><box-icon type='solid' name='right-arrow-circle'></box-icon><a href="#">Location</a></li>
                        <li className='flex gap-2 justify-start items-center'><box-icon type='solid' name='right-arrow-circle'></box-icon><a href="#">America</a></li>
                        <li className='flex gap-2 justify-start items-center'><box-icon type='solid' name='right-arrow-circle'></box-icon><a href="#">Asia</a></li>
                        <li className='flex gap-2 justify-start items-center'><box-icon type='solid' name='right-arrow-circle'></box-icon><a href="#">Europe</a></li>
                        <li className='flex gap-2 justify-start items-center'><box-icon type='solid' name='right-arrow-circle'></box-icon><a href="#">Africa</a></li>
                    </ul>
                </div>
